...
export const Footer = () => {
  ...
  const [endpointFooter, setEndpointFooter] = useState(
      ...
      {endpointFooter === "/cart" ? (
        <ConteinerFooter style={{ position: "sticky" }}>
          <div>
            ...
            >
              <g
                fill={endpointFooter === "/feed" ? "#E8222E" : "#B8B8B8"}
                fillRule="nonzero"
              >
          ...
          <div>
            ...
            >
              <g
                fill={endpointFooter === "/profile" ? "#E8222E" : "#B8B8B8"}
                fillRule="nonzero"
              >
        ...
        <ConteinerFooter style={{ position: "fixed" }}>
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="27"
